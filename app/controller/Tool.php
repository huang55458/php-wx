    ...
    public function jd(): void
    {
        $d = [
            [
                "id" => 883925,
                "group_id" => 8866,
                "waybill_code" => "Y987898888983",
                "order_id" => "300683322139",
                "type" => 1,
                "create_time" => "2024-12-12 10:26:57",
                "update_time" => "2024-12-12 10:26:57"
            ]
        ];
        foreach ($d as $item) {
            $data = [
            ...
            $uri = env('YUN_DAN_PROD') . '/api/OpenApi/JingDong/subscribe';
